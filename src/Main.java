...
public class Main implements Serializable {
    public static void main(String[] args) {
        ...
        int[] modifiedTour = new int[numberOfCities + 1]; // Include an extra element for returning to City 0
        for (int i = 0; i < numberOfCities; i++) {
            modifiedTour[i] = tour[i];
        }
        modifiedTour[numberOfCities] = tour[0]; // Set the last city to City 0
